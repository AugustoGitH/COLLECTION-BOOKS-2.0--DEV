module.exports = {
        ...
        },
        {
            ...
            collection: [
                ...
                },
                {
                    ...
                    description: 'Pegue: um experiente matador de aluguel que trabalha para o maior traficante de drogas sintéticas da cidade. Adicione: Uma jovem paraibana apaixonada; Uma loira estonteante de beleza surreal; Um velho mentor desbocado fã de histórias sobre a Máfia; Uma bolsa recheada de dólares; E... corpos... uma pilha deles... Junte: pesadelos terrivelmente perturbadores, uma incessante busca pela verdade cercada pela permanente sensação de dúvida sobre o que é real ou fruto de uma mente destruída pelo álcool... Misture tudo às traiçoeiras e sedutoras noites cariocas e pronto! Sirva- se enquanto ainda está quente... Esta é a receita da vida(morte?) de Marco Mafra. A cada página você estará mais próximo de descobrir a verdade..., mas... CUIDADO! Algumas revelações podem ter um custo muito alto. Principalmente, quando A MORTE FAZ SEU PREÇO..',
                    capa: "Comum",
                    autor: "por Bruno Crispim  (Autor), Ruhan Diniz (Ilustrador), Zishan Liu (Ilustrador) ",
                    valor: 41.50
                },
                ...
                },
                {
                    ...
                    description: 'Eleito LIVRO DO ANO pelo Prêmio Book Brasil “Misture personagens verdadeiramente humanos com ambientes fantásticos, chacoalhe bem e terá um livro de Bruno Crispim pronto para consumir” Felipe Sali, escritor e roteirista.',
                    capa: "Dura",
                    autor: "por Bruno Crispim  (Autor), Ruhan Diniz (Ilustrador), Zishan Liu (Ilustrador) ",
                    valor: 40.60
                }
    ...
    getAllLivros(){
        ...
        this.collections.forEach(collection=>{
            array.push(...collection.collection)
        })
        return array
    },
    findOne(id){
        return this.getAllLivros().filter(livro=> livro.id === id)[0]
    }
}
